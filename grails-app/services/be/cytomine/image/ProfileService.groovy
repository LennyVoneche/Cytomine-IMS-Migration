            ...
            def consumer = group.task {
                ...
                try {
                    ...
                    try {
                        ...
                        def dimensions = ch.systemsx.cisd.hdf5.MatrixUtils.dims(tileSize, tileSize, nSlices)
                        ...
                        def array = getTileMDArray((int[]) ch.systemsx.cisd.hdf5.MatrixUtils.dims(tileSize, tileSize), bpc)
